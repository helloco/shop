...
<div id="header">
    <h1><a href="./dashboard.html">系统管理员 </a></h1>
</div>
...
<div id="sidebar">
    ...
    <ul>
        <li><a href=""><i class="icon icon-home"></i> <span>系统管理员</span></a></li>

        <li>{{ HTML::link('system/addUser', '增加管理员') }}</li>
        <li>{{ HTML::link('system/viewUser', '查看管理员') }}</li>
        <li>{{ HTML::link('system/addShopView', '增加店铺') }}</li>
